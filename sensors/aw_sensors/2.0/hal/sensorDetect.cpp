...
int seSensorIndex[SUPPORT_SENSORS_NUMBER];
    ...
    {
        {
            ...
            0,0,SENSOR_FLAG_CONTINUOUS_MODE,
            { },
        },
    }, {
        {
    ...
    }, {
        {
            ...
            "Mi3da 3-axis Accelerometer",
            "miramems Semiconductor Inc.",
            1, 0,
            SENSOR_TYPE_ACCELEROMETER,
            RANGE_A,
            GRAVITY_EARTH/1024.0f,
        ...
        {
            "sc7660", 32.0f,    //for max range is 4G
        },  {
            "sc7660 3-axis Accelerometer",
            "silan",
            1, 0,
            SENSOR_TYPE_ACCELEROMETER,
            (GRAVITY_EARTH * 4.0f),
            GRAVITY_EARTH/1024.0f,   //for cts request
            0.5f, 10000,
            0,0,SENSOR_STRING_TYPE_ACCELEROMETER,
            0,1000000,SENSOR_FLAG_CONTINUOUS_MODE,
            { },
