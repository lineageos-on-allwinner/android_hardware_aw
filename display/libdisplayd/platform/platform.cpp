...
void initDisplayDevice(std::vector<DeviceControler*>& out, sunxi::IHWCPrivateService& client)
{
    out.push_back(new HdmiDevice(client));
    out.push_back(new CvbsDevice(client));
}
