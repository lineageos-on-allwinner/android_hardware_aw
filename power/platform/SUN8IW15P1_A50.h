#ifndef __SUN8IW15P1_A50_H__
#define __SUN8IW15P1_A50_H__
...
#define GPUCOMMAND "/sys/devices/gpu/scenectrl/command" //mode of  GPU scense control:0,1
#define GPUSTATUS  "/sys/devices/gpu/scenectrl/status" //switch of  GPU scense control:0,1


/*  value define -do not use*/
#define ROOMAGE_NORMAL     "0 0 0 0 1800000 4 0 0 "
